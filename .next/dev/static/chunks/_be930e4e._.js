...
function JobCard({ id, title, company, location, salary, matchScore, tags, posted, isApplied: initialApplied = false, onApply }) {
    ...
    const [isApplied, setIsApplied] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialApplied);
    ...
    const handleApply = async ()=>{
        ...
        try {
            setIsLoading(true);
            setError("");
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applicationsAPI"].apply(id);
            setIsApplied(true);
            onApply?.();
        } catch (err) {
...
_s(JobCard, "c1scxd/8vfMaDaMZqUufQOu92ag=");
_c = JobCard;
var _c;
...
//# sourceMappingURL=_be930e4e._.js.map