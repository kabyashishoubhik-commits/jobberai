...
"[project]/app/dashboard/resumes/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ResumesPage() {
    ...
    const handleFileUpload = async (e)=>{
        ...
        try {
            setLoading(true);
            setError("");
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resumeAPI"].upload(file);
            // Add to resumes list
            setResumes([
                {
                    id: resumes.length + 1,
...
//# sourceMappingURL=_ffa6650f._.js.map