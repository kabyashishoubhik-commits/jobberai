...
export const Card = ({ className, children }: { className?: string; children: React.ReactNode }) => {
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl bg-[#0a0a0a] dark:bg-[#0a0a0a] border border-white/10 shadow-[0_0_15px_rgba(0,0,0,0.6)] backdrop-blur-xl",
        className
      )}
    >
      {children}
...
export const CardTitle = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <h3 className={cn("text-lg font-semibold text-gray-100 dark:text-white py-2", className)}>
      {children}
    </h3>
  );
};
...
export const CardDescription = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <p className={cn("text-sm font-normal text-neutral-400 dark:text-neutral-400 max-w-sm", className)}>
      {children}
    </p>
  );
};
  ...
  return (
    <div
      className={cn(
        "h-[15rem] md:h-[20rem] rounded-xl z-40",
        className,
        showGradient && "bg-neutral-900 dark:bg-neutral-900 [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
      )}
    >
      {children}
    </div>
...
const Container = ({ className, children }: { className?: string; children: React.ReactNode }) => {
  return (
    <div
      className={cn(
        "h-16 w-16 rounded-full flex items-center justify-center bg-black/20 shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)]",
        className
      )}
    >
      {children}
