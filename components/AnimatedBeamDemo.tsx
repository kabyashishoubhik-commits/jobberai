...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-15 items-center justify-center rounded-full border-2 bg-white p-2 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[350px] w-full items-center justify-center overflow-hidden px-10 md:pb-24"
      ref={containerRef}
    >
      <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          ...
          <Circle ref={div5Ref}>
          <Image src={docs} alt={"docs"} width={80} height={80}/>
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref}>
          <Image src={foot} alt={"foot"} width={40} height={40}/>
          </Circle>
          <Circle ref={div4Ref} className="size-16">
            <Image src={blockchain} alt={"Block"} width={40} height={40}/>
          </Circle>
          <Circle ref={div6Ref}>
          <Image src={mic} alt={"mic"} width={120} height={120}/>
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref}>
          <Image src={scan} alt={"scan"} width={100} height={100}/>
          </Circle>
          <Circle ref={div7Ref}>
            <Image src={Tele} alt={"tele"} width={100} height={100}/>
