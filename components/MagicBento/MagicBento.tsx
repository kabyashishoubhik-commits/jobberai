...
const cardData: BentoCardProps[] = [
  {
    ...
    description: "Immutable on-chain record of event participation",
    label: "Authenticity",
  },
  {
    color: "#060010",
    title: "NFT Tickets",
    description: "Unique, tamper-proof tickets minted on-chain",
    label: "Ownership",
  },
  {
    color: "#060010",
    title: "Seamless Check-in",
    description: "QR + wallet verification for smooth entry",
    label: "Experience",
  },
  {
    color: "#060010",
    title: "Anti-Fraud",
    description: "No duplicates, no scalping, no fake tickets",
    label: "Trust",
  },
  {
    color: "#060010",
    title: "Community Rewards",
    description: "Reward attendees with exclusive drops & perks",
    label: "Engagement",
  },
  {
    color: "#060010",
    title: "Decentralized Storage",
    description: "Metadata & media secured via IPFS/Pinata",
    label: "Permanence",
  },
];
